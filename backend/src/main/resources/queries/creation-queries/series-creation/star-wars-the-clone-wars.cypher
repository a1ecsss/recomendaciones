...
MERGE (t9:Tag {name: 'Animation'})
MERGE (t10:Tag {name: 'Space'})
MERGE (t11:Tag {name: 'Strategy'})
MERGE (t12:Tag {name: 'Betrayal'})
MERGE (t13:Tag {name: 'Loyalty'})
MERGE (t14:Tag {name: 'Force'})
MERGE (t15:Tag {name: 'Galactic'})
